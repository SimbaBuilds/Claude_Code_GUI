...
- Once plan is created or change is decided, please delegate to Task agent on sonnet unless told otherwise. 
- Please rebuild project using one of the commands below after completing code changes:
make build      # JS only
